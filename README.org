...
pi.el supports custom slash commands from =~/.pi/agent/commands/= and
=.pi/commands/=. These appear in the transient menu (=C-c C-p=) and can be
invoked with =/command= in the input buffer with tab completion.

See the [[https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent#custom-slash-commands][pi documentation]] for creating custom commands.
...
- [[https://github.com/badlogic/pi-mono][pi-mono]] — Source code repository
